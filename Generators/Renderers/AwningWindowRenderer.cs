...
{
    /// <summary>
    /// Renders awning windows with a top hinge and outward-opening sash indication.
    /// </summary>
    public class AwningWindowRenderer : IWindowRenderer
    {
                              ...
                              WindowOpening window, WallGeometry wall, Vector3d offset)
        {
            ...
            // Hinge line at top of awning frame in plan representation.
            DrawingHelpers.AddLine(tr, btr,
                Off(wall.ToPlan(left + FrameWidth, depth / 2 - 0.02), offset),
                Off(wall.ToPlan(right - FrameWidth, depth / 2 - 0.02), offset),
                LayerManager.Layers.Windows);
            count++;

            // Open sash indication.
            DrawingHelpers.AddLine(tr, btr,
                                   ...
                                   WindowOpening window, double wallHeight, Vector3d offset)
        {
            ...
            DrawingHelpers.AddLine(tr, btr,
                ...
                P3(right - FrameWidth, top - FrameWidth, offset),
                LayerManager.Layers.Windows);
            count++;

            // Outward-opening sash (stylized diagonal).
            DrawingHelpers.AddLine(tr, btr,
                P3(left + FrameWidth, top - FrameWidth, offset),
                P3(right - FrameWidth, bottom + FrameWidth, offset),
                LayerManager.Layers.Windows);
            count++;
